# analyze credit card agreements from 
#https://catalog.data.gov/dataset/credit-card-agreements-database
#first: unzip the file and merge all files into one folder
# because these pdf lack of printable characters I decided to convert each pdf into an image and extrxt the text with ocr
# this procedure is NOT EFFICIENT due to the way pytesseract works. The process took me ~34 hours with 33 processes
...
import pandas as pd
import csv
from FogReadability import Readability
import re
import os
import shutil
import time
